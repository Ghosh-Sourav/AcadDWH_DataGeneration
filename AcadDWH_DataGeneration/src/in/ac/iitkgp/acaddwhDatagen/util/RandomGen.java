...
//		System.out.println("Rand Elem = " + randomElem);
	...
	public static String getCgpa() {
		ArrayList<String> elems = new ArrayList<String>();
		ArrayList<Double> freqs = new ArrayList<Double>();
		elems.add("9.5");		freqs.add(4.0);
		elems.add("9.0");		freqs.add(8.0);
		elems.add("8.5");		freqs.add(16.0);
		elems.add("8.0");		freqs.add(18.0);
		elems.add("7.5");		freqs.add(19.0);
		elems.add("7.0");		freqs.add(15.0);
		elems.add("6.5");		freqs.add(10.0);
		elems.add("6.0");		freqs.add(8.0);
		elems.add("5.5");		freqs.add(2.0);
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 100000; i++) {
			System.out.println("Inititaing line " + i + "...");
				content.append(getCgpa() + "\n");
		}
		String filePath = ProjectInfo.getPathToStore() + "test_CGPA" + ".csv";
